...
<template>
    <div>
        ...
        <div class="mid_img">
            <img style="width:100%;height:100%" src="../../images/tty/pic3@2x.png">
        </div>
        <div class="tip">出错啦,请重新尝试</div>
        <div class="reBtn" @click="rebtn">重新加载</div>
    </div>
</template>

<script>
// import alllist from 'src/page/personal/alllist/alllist'
