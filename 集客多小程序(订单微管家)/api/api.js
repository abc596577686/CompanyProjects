...
// 微信获取code
export const getWechatCode = params => { return query(`${baseUrl}/clt/miniProgram/getWechatCode.msp`, params, 'POST') }

// 获取微信授权登陆信息
export const getWeiXinUserInfo = params => { return query(`${baseUrl}/clt/miniProgram/getWeiXinUserInfo.msp`, params, 'POST') }
...
// 获取token
export const getToken = params => { return query(`${baseUrl}/clt/miniProgram/getToken.msp`, params, 'POST') }

// 品牌类目
export const getBrandList = params => { return query(`${baseUrl}/clt/index.json?a=v1/productBrandList`, params, 'POST') }

// 注册
export const userRegister = params => { return query(`${baseUrl}/clt/miniProgram/userRegister.msp`, params, 'POST') }
...
// 绑定微信手机号
export const bindWXPhone = params => { return query(`${baseUrl}/clt/miniProgram/bindWeixinMobile.msp`, params, 'POST') }

// // 绑定微信手机号 jkd
// export const bindWeixinMobile = params => { return query(`${baseUrl}/clt/miniProgram/bindWeixinMobile.msp`, params, 'POST') }

// 绑定其它手机号
export const bindOtherPhone = params => { return query(`${baseUrl}/clt/miniProgram/bindMoible.msp`, params, 'POST') }

// 获取手机号验证码
export const sendCode = params => { return query(`${baseUrl}/clt/user/sendCode.msp`, params, 'POST') }

// 验证旧手机号
export const modifyMobile = params => { return query(`${baseUrl}/clt/miniProgram/modifyMobile.msp`, params, 'POST') }

// 更改手机号
export const resetUserMobile = params => { return query(`${baseUrl}/clt/miniProgram/editMoible.msp`, params, 'POST') }
...
export const updateAddress = params => { return query(`${baseUrl}/clt/address/updateAddress.msp`, params, 'post') }

// export const webUploadImage = params => { return query(`${baseUrl}/clt/user/webUploadImage.msp`, params, 'post')}

// 身份证上传
export const saveIdentityInfo = params => { return query(`${baseUrl}/clt/certification/saveCertification.msp`, params, 'POST') }
...
// 实名认证列表
export const celebrityList = params => { return query(`${baseUrl}/clt/index.json?a=v1/userCertificationList`, params, 'POST') }
// 删除实名认证
export const delIdentityInfo = params => { return query(`${baseUrl}/clt/certification/deleteCertification.msp`, params, 'POST') }
// 授权手机号
export const bindMobile = params => { return query(`${baseUrl}/clt/miniProgram/bindMobile.msp`, params, 'POST') }
