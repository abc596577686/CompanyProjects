...
Page({
  ...
  saveAddressEnv(e) {
    ...
    params = {
      ...
      zipcode: '',
      realName: e.detail.value.realName != undefined ? e.detail.value.realName : '',
      identityNo: e.detail.value.identityNo != undefined ? e.detail.value.identityNo : '',
  ...
  _fillInfo() {
    ...
    this.setData({
      ...
      realName: curEditAddress.realName == 'undefined' ? '' : curEditAddress.realName,
  ...
  onLoad(options) {
    ...
    let realName = options.realName == 'undefined' ? '' : options.realName
