...
export default class GiftPack extends React.Component {
        ...
        customerList(params, 'GET').then(res => {
            if (res.data.code == 1) {
                ...
                let underTeamList = {
                    ...
                    totalYearsNumber: currentUnderTeamList.totalYearsNumber
                }
                this.setState({
                    underTeamList
                })
    ...
    goIssueRecord = () => {
        this.props.history.push('/userCenter/issueRecord');
    }
    goApplyRecord= () => {
        this.props.history.push('/userCenter/applyRecord');
    }
    goRebates= () => {
        this.props.history.push('/userCenter/rebates');
    }
            ...
            <div id='superWebUserCenter'>
                ...
                <div className='currentMonthList'>
                    ...
                    >
                        ...
                        <div onClick={this.goRebates}>
                            <p>商品返点</p>
                            <p>{ this.state.underTeamList.totalIncome? this.state.underTeamList.totalIncome:0 }</p>
                        </div>
                        <div>
                            <p>总年限值</p>
                            <p>{ this.state.underTeamList.totalYearsNumber? this.state.underTeamList.totalYearsNumber:0 }</p>
                        </div>
                    </Flex>
                </div>
                <WhiteSpace size="lg" />
