...
export default class GiftPack extends React.Component {
  ...
  setTeamMainData(teammaindata) {
    ...
    teammaindata.map((data,j)=> {
      teamData.push({
        ...
        indirectRenewNumber: data.indirectRenewNumber,
  ...
  renderMainData = () => {
    return <Table columns={this.state.teamColumns} dataSource={this.state.teamData} pagination={false} locale={this.state.tableEmpty}/>;
  }
                  ...
                  this.state.orderList.map((order, i) =>
                    <div key={i}>
                      <Table
                        ...
                        // expandedRowRender={this.rowRender.bind(this, order)}
                      >
                      </Table>
                    </div>
                  ) : null
