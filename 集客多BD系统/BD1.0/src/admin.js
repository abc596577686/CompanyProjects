...
import NavLeft from './globalComponents/NavLeft';
import CommonHeader from './globalComponents/Header';
...
class Admin extends React.Component {
  ...
  componentWillMount() {
    ...
    // sessionStorage.setItem( '__isFirstLogin__', 1 );
    // this._getUserInfo();
  };
        ...
        <Layout style={{minHeight: '100vh'}}>
            <Sider
                ...
                <div className="logo">
                    ...
                    <h1 style={{color: '#fff', textAlign:'center'}}>BD</h1>
                </div>
