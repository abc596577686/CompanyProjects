import { baseUrl ,baseUrls} from '../etc/config.js'
import { query, querys } from '../utils/index.js'
...
export const uploadQrCode = params => { return query(`${baseUrls}/clt/user/uploadQrCode.msp`, params, 'POST') }
...
// 获取二维码
export const getQrCode = params => { return query(`${baseUrl}/clt/user/getQrCode.msp`, params, 'POST') }
