    ...
    <div class="order_page">
        ...
        <div class="order_list_ul" v-if="cartList.length!=0" style="padding-top: 1.7rem;"> 
            <div class="head" style="z-index:198">
                <div class="shop_name">
                    <img v-show="checkAll" ='../../common/images/icon_dagou@2x.png' class="operation_icon" @click="docheckAll(0)">
                    <img v-show="!checkAll" ssrcrc='../../common/images/icon_yuan@2x.png' class="operation_icon" @click="docheckAll(1)">
                    ...
                    <div class="goods_name_price">
                        ...
                        <div class="goods_price">
                            ...
                            <div class="goods_num" v-show="editTex=='完成'">
                                ...
                                <input class="input-number" v-model="item.productNumber" @focus="inputFocus(item)" @blur="inputBlur(item)">
        ...
        methods: {
            ...
            docheckAll(i) {
                if (i == 0) {  // 取消全选
                    ...
                    //this.checkIsAll();
                    this.calculation();
                    // this.totalPrice = parseFloat(this.totalPrice) + parseFloat(this.totalSprice)
                }
            },
            docheck(item, actionType) {
                console.log(item)
                this.totalSprice = 111111
            ...
            calculation() {
                ...
                this.cartList.forEach(item => {
                    if (item.ischecked == true) {
                        ...
                        // console.log(parseFloat(this.totalSprice))       //初始
                        // console.log((item.tax)*(item.productNumber))    //单税费 X 数量

                        this.totalSprice = (parseFloat(this.totalSprice) + parseFloat((item.tax)*(item.productNumber))).toFixed(2);
                        console.log(this.totalPrice)   //商品价
                        console.log(parseFloat(this.totalSprice))  //税费
                        // this.totalSprice += (parseFloat(item.tax) * parseFloat(item.quantity));
                        // this.totalSprice = 0;
                    }
                })
                this.totalPrice = ((parseFloat(this.totalPrice))+(parseFloat(this.totalSprice))).toFixed(2)
