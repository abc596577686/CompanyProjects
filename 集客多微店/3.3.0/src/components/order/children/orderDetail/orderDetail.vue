        ...
        <!-- <lazy-render :time="300"> -->
            ...
            <section class="order_info white_color">
                <ul class="order_info_one">
                    <li v-for="product in productList">
                        <div class="order_info_one_div">
                            ...
                            <div class="thumb" style="color:#333;">
                                <img v-lazy="product.imageUrl">
                                <img v-show="product.isSoldOut=='1'" src="../../../../common/images/icon_qiangguang.png" style="position: absolute;width: 20%;height: 3.4rem; left: 0;">
                            </div>
                            <div>
                ...
                <ul class="order_info_two white_color">
                    ...
                    <li style="margin-top: -0.213rem;" v-if="orderData.productType ==2">
                        <div class="l_indent_content_shop_yf">
                            <p class="l_yf_p">税费</p>
            ...
            <section class="order_info_bot white_color">
                ...
                <p v-if="orderData.status != 1 && orderData.payTime!='' && orderData.payTime!=0" class="l_indent_content_shop_bh two">付款时间: <span>{{payTime}}</span></p>
            ...
            <section class="order-detail-footer white_color" v-if="orderData.status != 2 ">
                ...
                <p v-if="orderData.status==1" @click="ggcancelOrder2(orderData)" class="btn-payment bordercolor2 order-detail-bth-style">取消付款</p>
                ...
                <p v-if="orderData.status==2" @click="ggLogistics2(orderData)" class="btn-payment bordercolor2 order-detail-bth-style">查看物流</p>
