...
import { baseApiUrl, wechatUrl } from 'config/env'
...
//阳光海岸商品详情 
export const wechatProductDetail = (params, config) => { return util.ajax.post(`${wechatUrl}index.json`, params, config).then(res => res.data) }
