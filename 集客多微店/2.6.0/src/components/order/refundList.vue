    ...
    <div class="order_page">
        <!-- <lazy-render :time="300" style="margin-bottom: 60px;"> -->
            ...
            <div class="order_list_ul">
                ...
                <ul v-if="!emptyResult" style="margin-bottom:2.5rem;">
                    <li class="block block-order animated" v-for="item in orderList" :key="item.orderId">
                        ...
                        <div class="bottom" style="width:100%;float:right;" v-if="orderStatus != 6">
                            <div class="clearfix" style="float:right"><span class="font_size_11 font_color_black_3">共{{item.totalNumber}}件&nbsp;&nbsp;合计</span><span class="dark_gray font_size_13 font_color_black_2">￥{{item.payAmount}}</span>&nbsp;&nbsp;&nbsp;<span class="font_size_11 font_color_black_2">(含快递￥{{item.postage}})</span></div>
                        </div>
                        <div class="bottom" style="width:100%;float:right;" v-if="orderStatus == 6">
                        ...
                        <div class="clearfix" style="width:100%;float:right;">
                            ...
                            <p v-if="item.status==1 && orderStatus != 6" @click="docancelOrder(item)" class="orange-color js-delete-order font-size-12 btn-payment bordercolor2" style="float:right">取消订单</p>
                ...
                <!-- <div class="coerdiv" style="width:100%;height:1rem;"></div> -->
                <!-- </scroller> -->
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            orderStatusChange(id) {
                ...
                if(id == 6){
                    this.orderNoName = "售后订单："
                }else{
                    this.orderNoName = "订单号："
                }
                this.getOrderList();
            },
            doOprOrder() {
