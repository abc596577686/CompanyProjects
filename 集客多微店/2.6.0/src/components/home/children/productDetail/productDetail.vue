    ...
    <div>
        ...
        <div v-show="!showLoading">
            ...
            <div class="info_div">
                ...
                <!-- 普通商品价格 -->
                <p class="price" v-show="productInfo" style="color:#FB4A4C;font-size:20px;font-weight:600">¥{{productInfo.priceRegion}}  </p> 
                ...
                <!-- <p class="price" v-show="productInfo.isGroupProduct == 0 && isSeckillReadStatus == 1" style="color:#FB4A4C;font-size:20px;font-weight:600">¥{{productInfo.priceRegion}}  </p> -->
                <!-- 组合商品价格 -->
