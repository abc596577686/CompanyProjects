...
export default new VueRouter({
  ...
  routes: [
    ...
    {
      path: rootPath + '/wechatProductDetail',  //阳光海岸商品详情
      name: 'wechatProductDetail',
      component: resolve => require(['components/home/children/wechatProductDetail/productDetail'], resolve)
    },
    {
