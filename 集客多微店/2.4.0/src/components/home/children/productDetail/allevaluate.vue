<template>
    <div>
        <div v-title data-title="小伙伴们说"></div>
        <div v-if="evaluatedata.evaluateList.length != 0">
            <section class="headpf">  
                <img src="../../../../common/images/yellowstar.png">
                <div class="pftxt">{{evaluatedata.evaluateRate}}</div>
            </section>
            <section class="topimg" @click="goshareall()">
                <img :src="topcoverimg" style="width:100%;height100%;display:block">
            </section>
            <div class="allinNum">
                {{evaluatedata.evaluateQuantity}}
            </div>
            <section class="pfInfo" v-for="item in evaluatedata.evaluateList">
                <div class="info_headimg">
                    <img :src="item.userHeaderImage" v-if="item.userHeaderImage != ''">
                    <img src="../../../../common/images/localimg.png" v-if="item.userHeaderImage == ''">
                </div>
                <div class="info_name">{{item.nickName}}</div>
                <div class="coverimg" v-if="item.status == 3">
                ...
                <div class="info_imgg" v-if="item.imageUrlList !=0">
                    <img :src="items.imageUrl" v-for="items in item.imageUrlList">
                </div>
            </section>
            <section class="ccover"></section>
        </div>
        <div class="noinfo" v-if="evaluatedata.evaluateList.length == 0">
        <!-- <div class="noinfo" > -->
            <img src="../../../../common/images/gouwuche@2x.png">
            <div class="noinfo_img">该商品暂无评价</div>
        </div>
            ...
            <section class="choose_type_Container choose_spec_container" v-if="showBuy">
                ...
                <div class="list">
                    ...
                    <div class="gw_num" style="margin-top: 13px;">
                        ...
                        <input class="input-number" v-model="addcartpram.addNum" ></input>
...
<!-- 
        ...
        <footer class="foot_div" style="z-index:10000;height:2.1rem">
            ...
            <div class="actionGroup">
                ...
                <!--提示升级  status=3-->
                <button class="bt full" v-show="productInfo.isSeckillProduct == '1' && productStatus == 3" style="width: 55%;background: #FB4A4C;" @click="ktload">升级VIP1开启秒杀</button>
                <!--提示售罄  status=4-->
        ...
        <transition name="slide">
            <section v-if="yunfeikk" class="choose_type_Container">
        ...
        <transition name="fade">
            <span class="grey1" v-if="yunfeikk || iszhuce || showBuy || showChose || showDesc" @click="hideMask"></span>
        </transition>
...
<script>
    ...
    import qs from 'qs'
    import { productEvaluateList, getCityList, productDetail, addNumCart, orderCheckDetail, checkBuy, getPostage, shareProduct, getToken ,seckillList,userRegister,sendCode,seckillNotice} from 'api'
    ...
    methods: {
        ...
        init(){
            ...
            productEvaluateList(params).then(res => {
                ...
                if (res.code == '1'){         
                    console.log(res)
                    this.evaluatedata = res.data   //评价数据
                    this.topcoverimg = res.data.headerImageList[0].imageUrl
                }
            })
        },
        hideMask() {
